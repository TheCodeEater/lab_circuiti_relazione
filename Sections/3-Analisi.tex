...
\subsection{Analisi dell'ampiezza}
  ...
  \begin{figure}[H]
    ...
    \begin{subfigure}[t]{=0.49\textwidth}
      ...
      \includegraphics[width=\textwidth,height=\analysysFH]{cross_dataonly.png}
    ...
    \begin{subfigure}[t]{=0.49\textwidth}
      ...
      \includegraphics[width=\textwidth,height=\analysysFH]{cross_gain_amplitude.png}
...
\end{minipage}
  ...
  \begin{figure}[H]
    ...
    \begin{subfigure}[t]{=0.49\textwidth}
      \includegraphics[width=\textwidth,height=\analysysFH]{cross_reduced_range.png}
    ...
    \hfill
    \begin{subfigure}[t]{=0.49\textwidth}
      \includegraphics[width=\textwidth,height=\analysysFH]{cross_reduced_range_theoric.png}
...
\subsection{Analisi della fase}
  ...
  \begin{figure}[H]
    ...
    \begin{subfigure}{=0.49\textwidth}
      \centering
      \includegraphics[width=.99\textwidth,height=\analysysFH]{phase_dataonly.png}
    ...
    \begin{subfigure}{=0.49\textwidth}
      \centering
      \includegraphics[width=.99\textwidth,height=\analysysFH]{phase_cross.png}
