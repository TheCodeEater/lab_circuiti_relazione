...
\begin{abstract}
  ...
  \amplitudeF. Analizzando la tensione in ingresso del filtro, abbiamo ottenuto \vinF. Infine, analizzando lo sfasamento relativo, abbiamo ottenuto un valore di \phaseF. \\
  Sono risultati compatibili con il valore atteso la stima mediante fase e tensione in ingresso, quella mediante ampiezza sui due canali no.
