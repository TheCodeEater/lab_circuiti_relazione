...
L'analisi delle ampiezze ha prodotto risultati in disaccordo con la teoria, portando ad una stima della frequenza di cross non compatibile con quella attesa. Tuttavia, la compatibilità della frequenza di crossover stimata tramite $V_{in}$ con quella teorica suggerisce che l'apparato sperimentale funzioni correttamente. Se ci fossero malfunzionamenti nell'apparato, ci aspetteremmo discrepanze anche nelle misurazioni di $V_{in}$. Questo esclude problemi strumentali e indica che la teoria utilizzata per prevedere le ampiezze potrebbe essere inadeguata o incompleta.
